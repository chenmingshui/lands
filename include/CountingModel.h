...
namespace lands{
	...
	{ 
		public:
			...
			double EvaluateChi2(double *par, vector<double>& v_cachPdfValuestmp, vector< vector< vector<float> > >& vvv_cachPdfValuestmp, int bUseBestEstimateToCalcQ=1);          // for Chi2

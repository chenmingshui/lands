...
namespace lands{
	...
	class CLsBase
	{
		public:
			...
			bool BuildM2lnQ_b(int ntoys=100000, bool reUsePreviousToys=false, bool bWriteToys = false, TString jobname="");
			bool BuildM2lnQ_sb(int ntoys=100000, bool reUsePreviousToys=false, bool bWriteToys = false, TString jobname="");

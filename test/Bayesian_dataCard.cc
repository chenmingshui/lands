...
void processParameters(int argc, const char* argv[]){
	...
	if(argc<2) {
		...
		cout<<"./Bayesian_dataCard.exe inputFileName"<<endl;
		cout<<endl;
		cout<<" or "<<endl;
		cout<<"./Bayesian_dataCard.exe inputFileName calcExpectedMeanLimit=0 ntoys=100000 seed=1234 debug=0 XSprior=10"<<endl;
